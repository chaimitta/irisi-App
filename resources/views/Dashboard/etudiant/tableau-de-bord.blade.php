...
<!-- end of modal -->
  ...
  <tbody id="myTable">
    ...
    <tr>
       <td><a href="{{url('/voir_etudiant/'.$module->libelle)}}">{{$module->libelle}}</a></td>
     
       
      <td><a href="{{url('/etudiant-listeCours/'.$module->libelle)}}"
 class="pull-right"><i class="fa fa-eye" aria-hidden="true"></i> Voir la liste des cours</a></td>
 ...
 <td></td>
    ...
    @endforeach
     @endif
        ...
        <td ><span><i class="fa fa-calendar "  aria-hidden="true"></i><a  href="{{url('/etudiant-emplois/'.$semestre_id.'/'.$niveau_id)}}"  >  Emploi du temps </a></span></td>
            </div>
