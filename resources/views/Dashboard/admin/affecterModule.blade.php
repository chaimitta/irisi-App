          ...
          <div class="col-md-8">
           <div class="card">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Affecter ce professeur à un module</h4>
                          
                  <p class="card-category">Décrire le module en question </p>
                </div>
                <div class="card-body">
                @if(isset($professeur_id))
                <form method="post" action="/professeur-affecter1" enctype="multipart/form-data">
                @csrf
                  @if(isset($message))
                   ...
                   @endif
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <select name ="niveau" class="browser-default custom-select custom-select-lg mb-3 h-75 w-75">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                        <select name ="semestre" class="browser-default custom-select custom-select-lg mb-3 h-75 w-75">
