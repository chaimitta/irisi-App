      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Ajout des étudiants</a>
          </div> 
        ...
        <div class="container-fluid">
           <div class="card">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Affecter cet étudiant à un niveau et à une semestre</h4>
                          
                  <p class="card-category">Veillez remplir ces informations pour restaurer l'étudiant </p>
                </div>
                <div class="card-body">
                @if(isset($etudiant_id))
                <form method="post" action="/etudiant-restore" enctype="multipart/form-data">
                @csrf
                  @if(isset($message))
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{$etud->nom}}" disabled required >
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Prénom</label>
                          <input type="text" class="form-control" value="{{$etud->prenom}}" disabled required>
                        </div>
                      </div>
                  </div>
                 @endif
                  ...
                  <div class="col-md-4">
                        <div class="form-group">
                        <select name ="niveau" class="mdb-select md-form colorful-select dropdown-primary">
                          <option value="1">IRISI 1</option>
                          <option value="2">IRISI 2</option>
                          <option value="3">IRISI 3</option>
                          
                        </select>
                        <label class="mdb-main-label">Niveau</label>
                        
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                        <select name ="semestre" class="mdb-select md-form colorful-select dropdown-primary">
                          <option value="S1">Semestre 1</option>
                          <option value="S2">Semestre 2</option>
                          
                        </select>
                        <label class="mdb-main-label">Semestre</label>
                          
                        </div>
                      </div>
                  </div>
                <input type="hidden" value="{{$etudiant_id}}" name="etudiant_id">
                  <br>
                    <button type="submit" class="btn btn-primary pull-right">Sauvegarder</button>
                    <input type="button"
											class="btn btn-primary pull-left" onclick="javascript:location.href='{{url('/dashboard/archive')}}'" value="Retour" />
