          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                @if(isset($prof))
                  <form method="post" action="/dashboard/adminEditProf" enctype="multipart/form-data">
                  @csrf
                  @if(isset($message))
                  ...
                  @if(isset($message2))
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nomProf" required value="{{$prof->nom}}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Prénom</label>
                          <input type="text" class="form-control"  name="prenomProf" required value="{{$prof->prenom}}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">N° telephone</label>
                          <input type="tel" class="form-control" name="telProf" required value="{{$prof->tel}}">
                        </div>
                      </div>
                  </div>
                ...
                <script type="text/javascript">
                      window.location = "{{ url('/dashboard/adminProfesseur') }}";
                </script>
