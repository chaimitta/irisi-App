      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Les professeurs</a>
          </div> 
    ...
    <div class="modal-dialog">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="pull-right">
										<a href="{{url('/dashboard/ajouter_prof')}}" class="text-white"><h4><i
											class="fa fa-plus-circle"></i> Ajouter un professeur
										</h4></a>
									</div>
                      ...
                      <thead class=" text-primary">
                        ...
                        @foreach($prof as $p)
                          <tr>
                            ...
                            <a href="{{url('/professeur-affecter/'.$p->id)}}">
                                  <button type="submit" rel="tooltip" title="Affecter à un module" class="btn btn-white btn-round btn-just-icon">
                              ...
                              <a href="{{url('/dashboard/showAdminEditProf/'.$p->id)}}">
                             ...
                             <a href="#" data-toggle="modal" data-target="#delete{{$p->id}}">
     ...
     <div class="modal fade" id="delete{{$p->id}}">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Voullez-vous vraiment supprimer ce professeur ?</h4>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
              Cliquez sur supprimer pour supprimer le professeur.
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-success" data-dismiss="modal">Annuler</button>
              <a  onclick="javascript:location.href='{{url('/professeur-delete/'.$p->id)}}'">
