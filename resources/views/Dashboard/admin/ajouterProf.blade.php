      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Ajout des professeurs</a>
          </div> 
          ...
          <div class="col-md-8">
           <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Décrire le professeur à ajouter</p>
                </div>
                <div class="card-body">
                <form method="post" action="/dashboard/ajouter_prof" enctype="multipart/form-data">
                  @if(isset($message))
