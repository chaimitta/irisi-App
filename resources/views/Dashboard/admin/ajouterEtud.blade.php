          ...
          <div class="col-md-8">
           <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Décrire l'étudiant à ajouter </p>
                </div>
                <div class="card-body">
                <form method="post" action="/dashboard/ajouter_etud" enctype="multipart/form-data">
                @csrf
                  @if(isset($message))
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="codeApogee" required>
                        </div>
                      </div>
                  ...
                  <br>
                    ...
                    <input type="button"
											class="btn btn-primary pull-left" onclick="javascript:location.href='{{url('/dashboard/adminEtudiant')}}'" value="Retour" />
