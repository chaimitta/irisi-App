      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Editer le cours</a>
          </div>
...
<div class="content">
        ...
        <div class="card">
                ...
                @if(isset($message))
                  ...
                  <form  action="{{url('/cours/edit')}}" method="post" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nomCours" value="{{$nom_cours}}" required>
                        </div>
                      </div>
              ...
              <div class="col-md-12">
                 ...
                 <input type="hidden" name="oldnom" value="{{$nom_cours}}">
